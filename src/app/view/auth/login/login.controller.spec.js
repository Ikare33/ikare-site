describe(
        ...
        function() {
            ...
            it(
                    'should contain a property loginForm which is equal to afLoginForm service',
                    function() {
                        expect(LoginController.loginForm).toBe(loginForm);
                    });

            it(
                    'should call the login method of auth service when login method of the controller is called',
                    function() {
